  ...
  return (
    <section className="border-t border-primary/10 py-24 bg-background-light dark:bg-background-dark z-10">
      <div className="mx-auto max-w-4xl text-center px-6">
        ...
        <h2 className="mt-6 font-serif text-4xl font-light italic tracking-tight text-slate-900 dark:text-primary-100 md:text-5xl">
        ...
        <p className="mt-8 text-sm leading-relaxed tracking-wide text-slate-500 max-w-2xl mx-auto uppercase">
          Cada pieza es cuidadosamente elaborada a mano por maestros joyeros,
          combinando técnicas tradicionales con el diseño contemporáneo más
          vanguardista.
        </p>
      </div>
    </section>
