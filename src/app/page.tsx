      ...
      <section className="py-0">
        <div className="grid grid-cols-1 md:grid-cols-2 w-full">
          ...
          {[
            ...
            <Link key={idx} href={item.link} className="group relative aspect-square overflow-hidden bg-slate-900 block">
              <Image
                fill
              ...
              <div className="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-colors flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                  <span className="text-white uppercase tracking-[0.4em] font-medium text-lg drop-shadow-md">{item.tag}</span>
                  <span className="backdrop-blur-md border border-white/50 bg-transparent text-white text-[10px] uppercase tracking-[0.2em] px-4 py-2 rounded-custom transition-all duration-300 font-semibold hover:border-primary hover:text-white">
                    VER COLECCIÓN
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 grid-rows-2 h-full w-full">
              {[
                ...
                <div key={idx} className="relative group overflow-hidden h-full block">
                  <Image fill className="object-cover transition-transform duration-700 group-hover:scale-105" src={item.img} alt={item.tag} />
                  <Link href={item.link} className="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-colors flex items-center justify-center">
                    <div className="flex flex-col items-center gap-4">
                      <span className="text-white uppercase tracking-[0.4em] font-medium text-[10px] md:text-sm lg:text-lg">{item.tag}</span>
                    </div>
                  </Link>
                </div>
              ))}
